        ...
        <div class="box box-danger">
            ...
            <form action="{{ route('coupon.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="coupon_code" name="coupon_code" placeholder="Enter Coupon Code" value="{{ old('coupon_code') }}" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="discount_amount" name="discount_amount" placeholder="Enter Discount Amount" value="{{ old('discount_amount') }}" required min="0">
                </div>
